...
public class UserCartList {
	...
	public String toString() {
		return "UserCartList [userCartId=" + userCartId + ", userId=" + userId + ", productId=" + productId
				+ ", prodQuantity=" + prodQuantity + ", priceRate=" + priceRate + ", TotalRate=" + TotalRate
				+ ", variantId=" + variantId + ", rCreTime=" + rCreTime + ", rmodTime=" + rmodTime + ", prodName="
				+ prodName + ", productAvailabilty=" + productAvailabilty + ", productImage=" + productImage
				+ ", saveLater=" + saveLater + "]";
	}
